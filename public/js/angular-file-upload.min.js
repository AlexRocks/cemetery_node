        ...
        return{link: function(a, b, c) {
            ...
            return f.prototype = {constructor: f, _emptyFileFilter: function(b) {
                    ...
                    a.forEach(e, function(b) {
                        ...
                        }, this) : !0, e = new g(a.extend({url: this.url, alias: this.alias, headers: a.copy(this.headers), formData: a.copy(this.formData), removeAfterUpload: this.removeAfterUpload, method: this.method, uploader: this, file: b}, c));
                    ...
                    }), c.prop({action: b.url, method: b.method, target: d.prop('name'), enctype: 'multipart/form-data', encoding: 'multipart/form-data'}), d.bind('load', function() {
